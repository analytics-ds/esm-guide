---
title: "Enterprise Service Management: definition and scope"
...
faq:
  - question: "What is Enterprise Service Management?"
    answer: "Enterprise Service Management, or ESM, means applying to non-IT departments the service management practices that originated in IT: a formalised service catalogue, a single request portal, handling workflows and measured turnaround times. Human resources, facilities, finance and legal are the most frequent beneficiaries. The approach rests on method before it rests on tooling: without a written service catalogue, an ESM platform merely relocates the mess."
  - question: "What is the difference between ESM and ITSM?"
    answer: "ITSM covers the services delivered by the IT department. ESM applies the same principles to every support function in the organisation. Technically, both often run on the same platform and the same workflow engine."
  - question: "Do you need a dedicated tool to start with ESM?"
    answer: "Not necessarily. Most ITSM platforms already handle several service catalogues and several handling queues, which is enough to cover a first non-IT scope."
readingTime: true
---
...
| Department | Catalogued service | Typical request |
|---|---|---|
| Human resources | New joiner onboarding | Account creation and workstation setup |
| Facilities | Premises management | Room booking, air conditioning fault |
| Finance | Expense claim processing | Approval of an out-of-policy expense |
| Legal | Contract review | Review of a non-disclosure agreement |
...
<details>
<summary>What is Enterprise Service Management?</summary>
...
<details>
<summary>Do you need a dedicated tool to start with ESM?</summary>
